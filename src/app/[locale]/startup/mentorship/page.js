...
export default function MentorshipPage() {
  ...
  const t = dict.startupMentorship;

  const resources = [
    {
      name: "Pitch_Deck_v2.pdf",
      meta: t.resources.pitchDeckMeta,
      type: "file"
    },
    {
      name: t.resources.marketAnalysis,
      meta: "docs.google.com/spread...",
      type: "link"
    }
  ];

  const suggestions = [
    t.suggestions.reviewPitch,
    t.suggestions.businessModel,
    t.suggestions.financialPlan,
    t.suggestions.investorMeeting
  ];
      ...
      <main className="flex-grow flex flex-col h-full bg-white overflow-hidden">
        ...
        <header className="flex justify-between items-center px-8 py-5 bg-white border-b border-gray-100 w-full z-10 sticky top-0 shrink-0">
          <div className="flex items-center gap-12">
            <h1 className="text-xl font-bold text-gray-900 tracking-tight">{t.topbar.title}</h1>

            <div className="relative w-[400px] hidden lg:block">
              <div className="absolute inset-y-0 left-0 pl-4 flex items-center pointer-events-none text-gray-400">
                <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M21 21l-6-6m2-5a7 7 0 11-14 0 7 7 0 0114 0z"></path></svg>
              </div>
              <input type="text" placeholder={t.topbar.searchPlaceholder} className="w-full pl-11 pr-4 py-2 bg-[#f8fafc] border border-gray-100 rounded-xl text-xs outline-none focus:ring-2 focus:ring-[#0f3d32]/10 transition" />
            </div>
          </div>
        ...
        <div className="flex flex-grow overflow-hidden">
          ...
          <div className="w-[320px] shrink-0 border-r border-gray-100 bg-[#fcfcfd]/50 p-6 flex flex-col gap-6 overflow-y-auto">
            ...
            <div className="bg-white rounded-2xl border border-gray-100 p-8 shadow-sm text-center">
              ...
              <h2 className="text-lg font-bold text-gray-900 leading-tight mb-1">{t.mentor.name}</h2>
              <p className="text-[11px] text-[#0f3d32] font-bold uppercase tracking-widest mb-6">{t.mentor.role}</p>
              ...
              <div className="flex flex-col gap-4 text-left border-t border-gray-50 pt-6">
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    <p className="text-[9px] font-bold text-gray-400 uppercase tracking-widest mb-0.5">{t.mentor.expertiseLabel}</p>
                    <p className="text-[11px] font-bold text-gray-700">{t.mentor.expertiseValue}</p>
                  </div>
                </div>
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    <p className="text-[9px] font-bold text-gray-400 uppercase tracking-widest mb-0.5">{t.mentor.availabilityLabel}</p>
                    <p className="text-[11px] font-bold text-gray-700">{t.mentor.availabilityValue}</p>
                  </div>
                </div>
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    <p className="text-[9px] font-bold text-gray-400 uppercase tracking-widest mb-0.5">{t.mentor.nextSessionLabel}</p>
                    <p className="text-[11px] font-bold text-gray-700">{t.mentor.nextSessionValue}</p>
                  </div>
                </div>
              </div>
            ...
            <div className="bg-white rounded-2xl border border-gray-100 p-6 shadow-sm">
              <div className="flex items-center gap-2 mb-6">
                ...
                <h3 className="text-xs font-bold text-gray-900 tracking-tight">{t.resources.title}</h3>
              </div>
          ...
          <div className="flex-grow flex flex-col h-full bg-[#fcfcfd]/30">
            ...
            <div className="px-8 py-5 border-b border-gray-100 flex items-center justify-between bg-white/80 backdrop-blur-md">
              <div className="flex items-center gap-3">
                ...
                <h3 className="text-sm font-bold text-gray-900 tracking-tight">{t.chat.title}</h3>
              </div>
            ...
            <div className="flex-grow overflow-y-auto p-8 flex flex-col gap-8">
              ...
              <div className="flex justify-center">
                <span className="text-[10px] font-bold text-gray-400 uppercase tracking-[0.2em] bg-white px-4 py-1 rounded-full border border-gray-50 shadow-sm">{t.chat.date}</span>
              </div>
            ...
            <div className="p-8 border-t border-gray-100 bg-white shadow-[0_-4px_12px_rgba(0,0,0,0.02)]">
              ...
              <div className="flex items-center gap-4 bg-[#f8fafc] border border-gray-100 rounded-2xl p-4 group focus-within:border-[#0f3d32]/20 focus-within:ring-2 focus-within:ring-[#0f3d32]/5 transition shadow-sm">
                ...
                <input type="text" placeholder={t.input.placeholder} className="flex-grow bg-transparent border-none text-xs font-medium outline-none focus:ring-0 placeholder-gray-400" />
