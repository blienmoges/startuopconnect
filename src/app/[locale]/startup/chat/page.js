...
export default function InvestorChat() {
  ...
  const chats = [
    {
      id: "EthioVenture",
      name: "EthioVenture Capital",
      person: "Dawit Yemane",
      time: "10:24 AM",
      text: t.chats.ethioVenture.text,
      online: true,
      active: activeChat === "EthioVenture"
    },
    {
      id: "Sheba",
      name: "Sheba Angels",
      person: "Sara Tesfaye",
      time: t.chats.sheba.time,
      text: t.chats.sheba.text,
      online: true,
      status: t.status.online,
      statusType: "ONLINE",
      active: activeChat === "Sheba"
    },
    {
      id: "Zemen",
      name: "Zemen Fund",
      person: "Yared Alemu",
      time: t.chats.zemen.time,
      text: t.chats.zemen.text,
      offline: true,
      status: t.status.offline,
      statusType: "OFFLINE",
      active: activeChat === "Zemen"
    },
    {
      id: "Addis",
      name: "Addis Partners",
      time: t.chats.addis.time,
      text: t.chats.addis.text,
      status: t.status.waitingReply,
      statusType: "WAITING_REPLY",
      active: activeChat === "Addis"
    }
  ];
      ...
      <div className="w-[320px] bg-[#fcfcfd] border-r border-gray-100 flex flex-col shrink-0 h-full">
        <div className="p-6 pb-2">
          <div className="flex items-center justify-between mb-6">
            <h1 className="text-xl font-bold text-gray-900 tracking-tight">{t.sidebar.title}</h1>
            <span className="bg-[#eaf4f1] text-[#0f3d32] text-[9px] font-black uppercase tracking-widest px-2 py-1 rounded-lg">
              {t.sidebar.unread}
            </span>
          </div>

          <div className="flex gap-2 mb-6">
            {[t.filters.allChats, t.filters.investors, t.filters.unread].map((filter, i) => (
            ...
            >
              ...
              <div className="flex-grow min-w-0">
                ...
                <div className="flex items-center gap-1.5 mb-1">
                  {chat.status && (
                    <span className={`text-[8px] font-black tracking-widest px-1.5 py-0.5 rounded ${chat.statusType === "ONLINE"
                      ? 'bg-[#f0fdf4] text-[#16a34a]'
                      : chat.statusType === "OFFLINE"
      ...
      <div className="flex-grow bg-white flex flex-col h-full">
        ...
        <header className="px-8 py-5 border-b border-gray-100 flex items-center justify-between bg-white z-10">
          <div className="flex items-center gap-8 flex-grow">
            ...
            <div className="relative w-full max-w-[400px] hidden lg:block">
              ...
              <input type="text" placeholder={t.header.searchPlaceholder} className="w-full pl-11 pr-4 py-2 bg-[#f8fafc] border border-gray-100 rounded-xl text-xs outline-none focus:ring-2 focus:ring-[#0f3d32]/10 transition" />
            </div>
          </div>
        ...
        <div className="flex-grow overflow-y-auto p-8 flex flex-col gap-8 bg-[#fcfcfd]/30">
          ...
          <div className="flex justify-center">
            <span className="text-[10px] font-bold text-gray-400 uppercase tracking-[0.2em] bg-white px-4 py-1 rounded-full border border-gray-50 shadow-sm">{t.history.today}</span>
          </div>
              ...
              <div className="bg-white border border-gray-100 rounded-xl p-4 shadow-sm flex items-center justify-between gap-8 min-w-[280px]">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-[10px] text-gray-400 font-medium">2.4 MB • {t.history.pdfDocument}</p>
                  </div>
                </div>
        ...
        <div className="p-8 border-t border-gray-100 bg-white">
          ...
          <div className="flex justify-between items-center mt-3 px-1">
            <div className="flex items-center gap-1.5">
              ...
              <span className="text-[10px] text-gray-400 font-medium">{t.input.encrypted}</span>
            </div>
            <span className="text-[10px] text-gray-400 font-medium tracking-tight">{t.input.enterToSend}</span>
          </div>
        </div>
