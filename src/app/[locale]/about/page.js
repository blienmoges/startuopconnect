    ...
    <div className="min-h-screen flex flex-col font-sans text-gray-900 bg-white">
      ...
      <header className="border-b border-gray-100 sticky top-0 bg-white z-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-20 flex items-center justify-between">
          ...
          <nav className="hidden md:flex items-center gap-8 text-sm font-medium">
            ...
            <Link href={`/${currentLocale}/about`} className="text-primary transition-colors">{common.nav.about}</Link>
      ...
      <main className="flex-grow">
        ...
        <section className="pt-24 pb-20 px-4 sm:px-6 lg:px-8">
          <div className="max-w-6xl mx-auto grid md:grid-cols-2 gap-12 items-center">
            ...
            <div className="flex flex-col justify-center">
              <span className="text-primary text-sm font-semibold uppercase tracking-widest mb-3">About Us</span>
            ...
            <div className="relative rounded-2xl overflow-hidden shadow-xl h-[420px]">
              <Image
                src="/about-team.jpg"
                alt="StartupConnect Ethiopia team collaborating"
                fill
                className="object-cover object-center"
                priority
              />
              {/* Subtle green tint overlay at bottom */}
              <div className="absolute bottom-0 left-0 right-0 h-1/3 bg-gradient-to-t from-[#167b66]/40 to-transparent" />
            </div>
          </div>
        </section>
        ...
        <section className="py-20 bg-white px-4 sm:px-6 lg:px-8 max-w-4xl mx-auto text-center border-t border-gray-100">
          <h2 className="text-3xl font-bold text-gray-900 mb-8">{t.challenge.title}</h2>
          ...
          <div className="max-w-6xl mx-auto text-center mb-16">
            ...
            <div className="grid md:grid-cols-4 gap-6 mt-12 text-left">
              <div className="bg-white p-8 rounded-xl shadow-sm border border-gray-100 flex flex-col">
                ...
                <h3 className="text-xl font-bold mb-3">{t.solution.card1.title}</h3>
                <p className="text-gray-600 text-sm leading-relaxed">{t.solution.card1.description}</p>
              </div>
              ...
              <div className="bg-white p-8 rounded-xl shadow-sm border border-gray-100 flex flex-col">
                ...
                <h3 className="text-xl font-bold mb-3">{t.solution.card2.title}</h3>
                <p className="text-gray-600 text-sm leading-relaxed">{t.solution.card2.description}</p>
              </div>
              ...
              <div className="bg-white p-8 rounded-xl shadow-sm border border-gray-100 flex flex-col">
                ...
                <h3 className="text-xl font-bold mb-3">{t.solution.card3.title}</h3>
                <p className="text-gray-600 text-sm leading-relaxed">{t.solution.card3.description}</p>
              </div>
              ...
              <div className="bg-white p-8 rounded-xl shadow-sm border border-gray-100 flex flex-col">
                ...
                <h3 className="text-xl font-bold mb-3">{t.solution.card4.title}</h3>
                <p className="text-gray-600 text-sm leading-relaxed">{t.solution.card4.description}</p>
              </div>
            </div>
          </div>
        </section>
        ...
        <section className="py-20 px-4 sm:px-6 lg:px-8 max-w-6xl mx-auto border-t border-gray-100">
          <h2 className="text-3xl font-bold text-center text-gray-900 mb-16">{t.values.title}</h2>
          <div className="grid md:grid-cols-4 gap-6 text-left">
            <div className="bg-white p-8 rounded-xl shadow-sm border border-gray-100 flex flex-col text-left">
              ...
              <h3 className="text-xl font-bold mb-3">{t.values.card1.title}</h3>
              <p className="text-gray-600 text-sm leading-relaxed">{t.values.card1.description}</p>
            </div>
            <div className="bg-white p-8 rounded-xl shadow-sm border border-gray-100 flex flex-col text-left">
              <div className="text-primary mb-4">
              ...
              <h3 className="text-xl font-bold mb-3">{t.values.card2.title}</h3>
              <p className="text-gray-600 text-sm leading-relaxed">{t.values.card2.description}</p>
            </div>
            <div className="bg-white p-8 rounded-xl shadow-sm border border-gray-100 flex flex-col text-left">
              <div className="text-primary mb-4">
                <svg className="w-8 h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M17.657 16.657L13.414 20.9a1.998 1.998 0 01-2.827 0l-4.244-4.243a8 8 0 1111.314 0z"></path><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M15 11a3 3 0 11-6 0 3 3 0 016 0z"></path></svg>
              </div>
              <h3 className="text-xl font-bold mb-3">{t.values.card3.title}</h3>
              <p className="text-gray-600 text-sm leading-relaxed">{t.values.card3.description}</p>
            </div>
            <div className="bg-white p-8 rounded-xl shadow-sm border border-gray-100 flex flex-col text-left">
              <div className="text-primary mb-4">
                <svg className="w-8 h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M4 16l4.586-4.586a2 2 0 012.828 0L16 16m-2-2l1.586-1.586a2 2 0 012.828 0L20 14m-6-6h.01M6 20h12a2 2 0 002-2V6a2 2 0 00-2-2H6a2 2 0 00-2 2v12a2 2 0 002 2z"></path></svg>
              </div>
              <h3 className="text-xl font-bold mb-3">{t.values.card4.title}</h3>
              <p className="text-gray-600 text-sm leading-relaxed">{t.values.card4.description}</p>
            </div>
          </div>
        </section>
        ...
        {/* Our Team */}
        <section className="py-20 px-4 sm:px-6 lg:px-8 max-w-6xl mx-auto border-t border-gray-100">
          <h2 className="text-3xl font-bold text-center text-gray-900 mb-16">{t.team.title}</h2>
          <div className="grid md:grid-cols-4 gap-8 text-center">
            ...
            <div className="bg-white p-8 rounded-xl shadow-sm border border-gray-100 flex flex-col items-center hover:shadow-md transition">
              <div className="w-24 h-24 rounded-full bg-gray-200 mb-4 overflow-hidden relative">
                <div className="absolute inset-0 flex items-center justify-center text-gray-400 bg-gray-200 text-xs">{t.team.image}</div>
              </div>
              <h3 className="text-lg font-bold">{t.team.member1.name}</h3>
              <p className="text-sm text-gray-500">{t.team.member1.role}</p>
            </div>
            {/* Team Member 2 */}
            <div className="bg-white p-8 rounded-xl shadow-sm border border-gray-100 flex flex-col items-center hover:shadow-md transition">
              <div className="w-24 h-24 rounded-full bg-gray-200 mb-4 overflow-hidden relative">
              ...
              <h3 className="text-lg font-bold">{t.team.member2.name}</h3>
              <p className="text-sm text-gray-500">{t.team.member2.role}</p>
            </div>
            {/* Team Member 3 */}
            <div className="bg-white p-8 rounded-xl shadow-sm border border-gray-100 flex flex-col items-center hover:shadow-md transition">
              <div className="w-24 h-24 rounded-full bg-gray-200 mb-4 overflow-hidden relative">
              ...
              <h3 className="text-lg font-bold">{t.team.member3.name}</h3>
              <p className="text-sm text-gray-500">{t.team.member3.role}</p>
            </div>
            {/* Team Member 4 */}
            <div className="bg-white p-8 rounded-xl shadow-sm border border-gray-100 flex flex-col items-center hover:shadow-md transition">
              <div className="w-24 h-24 rounded-full bg-gray-200 mb-4 overflow-hidden relative">
              ...
              <h3 className="text-lg font-bold">{t.team.member4.name}</h3>
              <p className="text-sm text-gray-500">{t.team.member4.role}</p>
            </div>
          </div>
        </section>
        ...
        <section className="py-20 bg-[#167b66] text-center px-4">
          <div className="max-w-4xl mx-auto">
            ...
            <button className="px-8 py-3 mt-4 bg-white text-[#167b66] font-bold rounded-md hover:bg-gray-100 transition shadow-lg">{t.cta.button}</button>
          </div>
        </section>
      </main>
