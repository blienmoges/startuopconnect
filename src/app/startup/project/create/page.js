            ...
            <div className="lg:col-span-2 flex flex-col gap-6">
              ...
              <div className="bg-white rounded-2xl shadow-[0_2px_10px_rgba(0,0,0,0.02)] border border-gray-100 p-8 flex flex-col gap-6">
                ...
                <div>
                  ...
                  <input type="text" placeholder="e.g. AgriTech Ethiopia Hub" className="w-full px-4 py-3 bg-white border border-gray-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-[#0f3d32]/20 focus:border-[#0f3d32] transition text-sm text-gray-800 placeholder-gray-400" />
                </div>
                ...
                <div>
                  ...
                  <input type="text" placeholder="A one-sentence elevator pitch" className="w-full px-4 py-3 bg-white border border-gray-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-[#0f3d32]/20 focus:border-[#0f3d32] transition text-sm text-gray-800 placeholder-gray-400" />
                </div>

                {/* Problem Statement */}
                <div>
                  <label className="block text-xs font-bold text-gray-900 mb-2">Problem Statement</label>
                  <textarea rows="3" placeholder="What specific problem are you solving in the Ethiopian market?" className="w-full px-4 py-3 bg-white border border-gray-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-[#0f3d32]/20 focus:border-[#0f3d32] transition text-sm text-gray-800 placeholder-gray-400 resize-none"></textarea>
                </div>

                {/* Solution */}
                <div>
                  <label className="block text-xs font-bold text-gray-900 mb-2">Solution</label>
                  <textarea rows="3" placeholder="How does your startup solve this problem uniquely?" className="w-full px-4 py-3 bg-white border border-gray-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-[#0f3d32]/20 focus:border-[#0f3d32] transition text-sm text-gray-800 placeholder-gray-400 resize-none"></textarea>
                </div>
                ...
                <div className="grid sm:grid-cols-2 gap-5">
                  ...
                  <div>
                    ...
                    <input type="text" placeholder="e.g. 500+ jobs created" className="w-full px-4 py-3 bg-white border border-gray-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-[#0f3d32]/20 focus:border-[#0f3d32] transition text-sm text-gray-800 placeholder-gray-400" />
                  </div>
                </div>
              ...
              <div className="flex flex-wrap items-center gap-4">
                ...
                <Link href="/startup/project/documents" className="px-6 py-3.5 bg-[#0f3d32] hover:bg-[#0a2921] text-white font-bold rounded-lg transition shadow-md text-xs">
              ...
              <div className="bg-white rounded-2xl shadow-[0_8px_30px_rgba(0,0,0,0.04)] border border-gray-100 overflow-hidden sticky top-[100px]">
                ...
                <div className="p-5">
                  ...
                  <div className="flex justify-between items-start mb-3">
                    <h3 className="text-xl font-bold text-[#0f3d32]">[Project Name]</h3>
                    <span className="bg-[#eaf4f1] text-[#136150] text-[9px] font-bold uppercase tracking-widest px-2 py-0.5 rounded border border-[#cde5dd]">[STAGE]</span>
                  </div>

                  <p className="text-xs text-gray-400 italic mb-6">"Your short summary will appear here..."</p>
              ...
              <div className="bg-[#e8f5e9] rounded-xl p-4 flex items-start gap-3 border border-[#c8e6c9]">
                <div className="text-[#0f3d32] shrink-0 mt-0.5">
                  <svg className="w-4 h-4" viewBox="0 0 24 24" fill="currentColor">
                     ...
                     <path d="M11 7h2v2h-2zm0 4h2v6h-2z"/> {/* Fake bulb */}
                  </svg>
                </div>
