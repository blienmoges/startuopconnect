      ...
      <main className="flex-grow flex flex-col overflow-y-auto">
          ...
          <div className="flex items-center gap-6 ml-auto">
            ...
            <div className="flex items-center gap-3">
              <div className="hidden sm:flex flex-col items-end">
                <span className="text-xs font-bold text-gray-900">GreenTech Solutions</span>
              ...
              <div className="w-8 h-8 rounded-full bg-gray-200 overflow-hidden shrink-0 border border-gray-200">
                {/* Avatar placeholder */}
                <div className="w-full h-full bg-[#115b4c] text-white flex items-center justify-center font-bold text-[10px]">GT</div>
              </div>
            </div>
          </div>
        </header>
        ...
        <div className="px-4 sm:px-8 pb-12 w-full max-w-[1200px] mx-auto">
          ...
          <div className="mb-8 mt-2">
            <h1 className="text-2xl font-bold text-gray-900 mb-1 tracking-tight">Welcome back, GreenTech Solutions.</h1>
            <p className="text-xs text-gray-500 font-medium">Your venture is performing well. You have 2 new updates from your mentor.</p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <div className="md:col-span-2 bg-white rounded-[20px] p-6 shadow-sm border border-gray-100 flex flex-col justify-between">
              ...
              <div className="flex items-center justify-between mt-auto mb-2 relative">
                ...
                <div className="flex flex-col items-center gap-2">
                  ...
                  <span className="text-[10px] font-bold text-gray-300">Pending</span>
                </div>
                ...
                <div className="flex flex-col items-center gap-2">
                  ...
                  <span className="text-[10px] font-bold text-gray-300">Active</span>
                </div>
                ...
                <div className="flex flex-col items-center gap-2 relative">
                  ...
                  <span className="text-[10px] font-bold text-[#0f3d32]">Funded</span>
                </div>
                ...
                <div className="flex flex-col items-center gap-2">
                  ...
                  <span className="text-[10px] font-bold text-gray-300">Closed</span>
                </div>
              </div>
            </div>

            {/* Project Progress (Col Span 1) */}
            <div className="bg-white rounded-[20px] p-6 shadow-sm border border-gray-100 flex flex-col items-center justify-center text-center">
              ...
              <div className="relative w-24 h-24 mb-4">
                <svg className="w-full h-full transform -rotate-90" viewBox="0 0 36 36">
                  ...
                  {/* Progress Line */}
                  <path className="text-[#0f3d32]" strokeDasharray="65, 100" strokeLinecap="round" d="M18 2.0845 a 15.9155 15.9155 0 0 1 0 31.831 a 15.9155 15.9155 0 0 1 0 -31.831" fill="none" stroke="currentColor" strokeWidth="4" />
                </svg>
                <div className="absolute inset-0 flex items-center justify-center">
                  <span className="text-xl font-bold text-[#0f3d32]">65%</span>
                </div>
              </div>

              <p className="text-xs text-gray-600 font-medium mb-2">MVP Phase: Integration.</p>
              <Link href="#" className="text-[10px] font-bold text-[#0f3d32] hover:underline flex items-center gap-1">
                View Details
            ...
            <div className="md:col-span-2 bg-white rounded-[20px] p-6 shadow-sm border border-gray-100 flex flex-col justify-between">
              ...
              <div className="mb-6">
                <div className="flex justify-between items-end mb-2">
                  ...
                  <span className="text-xl font-bold text-gray-900 leading-none">$500k</span>
                </div>
                <div className="w-full bg-[#f0f2f5] rounded-full h-1.5 flex overflow-hidden">
                  ...
                  <div className="bg-[#0f3d32] h-full" style={{ width: '20%' }}></div>
                </div>
              </div>
              ...
              <div className="flex gap-12">
                <div>
                  ...
                  <p className="text-lg font-bold text-gray-600">$250k</p>
                </div>
                <div>
                  <div className="flex items-center gap-1.5 text-[10px] font-bold text-gray-400 uppercase tracking-widest mb-1">
                  ...
                  <p className="text-lg font-bold text-[#0f3d32]">$100k</p>
                </div>
              </div>
            </div>

            {/* Documents Status (Col Span 1) */}
            <div className="bg-white rounded-[20px] p-6 shadow-sm border border-gray-100 flex flex-col gap-3">
              ...
              <div className="bg-[#f2fbf7] border border-[#dcfce7] rounded-xl p-3.5 flex items-center justify-between">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <h4 className="text-xs font-bold text-[#0f3d32]">8 Uploaded</h4>
              ...
              <div className="bg-[#fff5f5] border border-[#fed7d7] rounded-xl p-3.5 flex items-center justify-between">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <h4 className="text-xs font-bold text-red-600">3 Missing</h4>
                    <p className="text-[9px] text-red-400 uppercase tracking-widest font-bold">Action Required</p>
                  </div>
                </div>
                <button className="bg-red-600 hover:bg-red-700 text-white text-[10px] font-bold px-3 py-1.5 rounded-md transition">
                  Fix Now
                </button>
              </div>
            </div>
            ...
            <div className="bg-white rounded-[20px] p-6 shadow-sm border border-gray-100 relative overflow-hidden flex flex-col justify-between">
              ...
              <div className="absolute -top-4 -right-2 text-[#f3f4f6] text-[100px] leading-none font-serif select-none pointer-events-none">
                "
              </div>
              <h3 className="text-[10px] font-bold text-gray-400 uppercase tracking-widest mb-4 relative z-10">Latest Feedback</h3>

              <p className="text-sm text-gray-800 font-medium italic mb-6 leading-relaxed relative z-10">
                "Great progress on the MVP, looking forward to the next update."
              </p>
              ...
              <div className="flex items-center gap-3 relative z-10">
                ...
                <div>
                  <h4 className="text-xs font-bold text-gray-900">Menber Bareh</h4>
                  <p className="text-[10px] text-gray-500">Tech Lead at EthioCapital</p>
                </div>
              </div>
            </div>
            ...
            <div className="bg-[#0f3d32] rounded-[20px] p-6 shadow-md text-white flex flex-col justify-between relative overflow-hidden">
              ...
              <div className="relative z-10 flex justify-between items-start mb-4">
                <div className="w-10 h-10 bg-[#165042] rounded-xl flex items-center justify-center text-[#dcfce7]">
              ...
              <div className="relative z-10 flex justify-between items-center mt-auto">
                ...
                <button className="bg-white hover:bg-gray-50 text-[#0f3d32] text-[11px] font-bold px-4 py-2 rounded-lg transition shadow-sm">
                  Join Room
                </button>
              </div>
            </div>
              ...
              <div className="flex flex-col gap-4">
                ...
                <div className="flex gap-3">
                  <div className="flex flex-col items-center mt-0.5">
                    <div className="w-5 h-5 rounded-full border border-[#dcfce7] bg-[#f0fdf4] text-[#136150] flex items-center justify-center shrink-0">
                  ...
                  <div className="pb-1">
                    <h4 className="text-[11px] font-bold text-gray-900">Project updated</h4>
                    <p className="text-[9px] text-gray-400">2 hours ago • API Gateway Launched</p>
                  </div>
                </div>
                ...
                <div className="flex gap-3">
                  <div className="flex flex-col items-center mt-0.5">
                    <div className="w-5 h-5 rounded-full border border-gray-200 bg-white text-gray-400 flex items-center justify-center shrink-0">
                  ...
                  <div className="pb-1">
                    <h4 className="text-[11px] font-bold text-gray-900">Document uploaded</h4>
                    <p className="text-[9px] text-gray-400">Yesterday • Tax clearance.pdf</p>
                  </div>
                </div>
                ...
                <div className="flex gap-3">
                  ...
                  <div className="pb-1">
                    <h4 className="text-[11px] font-bold text-gray-900">New message received</h4>
                    <p className="text-[9px] text-gray-400">4 days ago • From: Menber Bareh</p>
                  </div>
                </div>
