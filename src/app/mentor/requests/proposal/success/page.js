                ...
                <div className="flex-grow flex flex-col gap-6 w-full lg:w-[65%]">
                   ...
                   <div className="flex flex-col sm:flex-row gap-4 mt-2">
                      ...
                      <button 
                         ...
                         className="flex-1 py-4 bg-white border border-gray-200 text-[#0a3a2e] text-[13px] font-bold rounded-xl hover:bg-gray-50 transition shadow-sm flex items-center justify-center gap-2"
                      >
