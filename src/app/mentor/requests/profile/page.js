           ...
           <div className="p-8 lg:p-10 max-w-[1200px] w-full mx-auto flex flex-col pb-20">
             ...
             <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-6 mb-10">
                ...
                <div className="flex items-center gap-3 w-full md:w-auto">
                   <button onClick={() => router.push('/mentor/messages')} className="flex-grow md:flex-grow-0 px-6 py-2.5 bg-gray-100 text-gray-700 text-[13px] font-bold rounded-xl hover:bg-gray-200 transition flex items-center justify-center gap-2">
