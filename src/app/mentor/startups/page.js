               ...
               <div className="flex items-center gap-5">
                  ...
                  <div className="flex items-center gap-3">
                     <div className="w-8 h-8 rounded-full overflow-hidden bg-gray-200 shrink-0">
                        <img src="https://i.pravatar.cc/150?img=11" alt="Dr. Abel Tadesse" className="w-full h-full object-cover" />
                     </div>
                     <div className="flex flex-col">
                        <span className="text-sm font-bold text-gray-900 leading-tight">Dr. Abel Tadesse</span>
                        <span className="text-[9px] font-bold text-gray-500 uppercase tracking-wider">Senior Advisor</span>
                     </div>
                  </div>
               </div>
            </header>
